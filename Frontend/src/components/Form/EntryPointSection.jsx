  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-black-100">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-xl font-semibold text-black-900">Entry Point</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <motion.button
          ...
          className="w-full py-2 px-4 border border-green-600 text-green-600 rounded-md hover:bg-green-50"
          initial={{ scale: 0.95 }}
          animate={{ scale: 1 }}
          exit={{ scale: 0.95 }}
